...
const QTYPES = ["All Types","Multiple Choice","True / False","Identification","Short Answer", "Coding", "Mathematics"];
  ...
  const handleSave = async () => {
    ...
    try {
      const payload = {
        ...
        choices: ["Coding", "Mathematics", "Identification", "Short Answer"].includes(type) ? [] : choices,
