...
export const SHIELD_CARDS: PowerCardData[] = [
  {
    ...
    category: 'shield',
    name: 'Iron Wall',
    description: 'Grants 5 shield points that absorb damage first.',
    cost: 20,
    rarity: 'common',
  ...
  },
  {
    ...
    category: 'shield',
    name: 'Barrier Surge',
    description: 'Stacks 3 extra shield on top of any shield you already have.',
    cost: 25,
    rarity: 'rare',
  ...
  },
  {
    ...
    category: 'shield',
    name: 'Aegis',
    description: 'A heavy 10-point barrier for the next hit that lands.',
    cost: 45,
    rarity: 'epic',
