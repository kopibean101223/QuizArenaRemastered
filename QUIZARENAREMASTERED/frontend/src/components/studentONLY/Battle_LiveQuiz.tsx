...
import type { BattleQuestion, NormalizedQuestion } from "@/lib/student/battle/useBattleConnection";

// Grading logic per question type. Multiple Choice / True-False are exact
// matches; text types normalize whitespace/case before comparing; Numerical
// Input allows an optional +/- tolerance; Mathematics does a light
// whitespace/case normalize only (swap in a real expression-equivalence
// check later if `allowEquivalentForms` needs to mean more than that).
...
// What to show in the "Correct answer: ___" summary after reveal.
