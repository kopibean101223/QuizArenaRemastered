    ...
    <>
      ...
      <div style={{ minHeight:"100vh", paddingTop:56, background:`radial-gradient(ellipse at 50% 0%, rgba(255,71,87,0.2) 0%, transparent 60%), ${C.navy}` }}>
        ...
        <div style={{ maxWidth:700, margin:"24px auto 36px", padding:"0 20px", display:"flex", gap:12 }}>
          <button type="button" onClick={() => navigate("student_dashboard")} style={{ flex:1, background:C.red, border:"none", borderRadius:16, padding:"14px", fontFamily:"Fredoka, sans-serif", fontSize:18, fontWeight:700, color:"#fff", cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center", gap:8 }}>
